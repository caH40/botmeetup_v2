...
export const editPostText =
	'Можно редактировать или удалять только те объявления о заездах которые еще не состоялись. Полностью удалить объявление можно в течении двух суток после его создания. Позже данного времени для удаления объявления необходимо обратиться к админу канала.';
