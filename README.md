...
7. Командой /setup Добавить API-key для мониторинга с сайта [openweathermap.org](https://openweathermap.org/api) (необходимо зарегистрироваться и получить API-key);
8. Добавить "места старта" в настройки бота /location;
9. Добавить к "местам старта" соответствующие места мониторинга погоды /weather.
